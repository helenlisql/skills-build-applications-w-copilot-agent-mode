      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <a className="btn btn-outline-light" href="https://github.com" target="_blank" rel="noopener noreferrer">GitHub</a>
          </div>
        </div>
      </nav>
        ...
        <Routes>
          ...
          <Route path="/" element={
            <div className="card text-center p-5">
              <h2 className="display-4 mb-3">Welcome to OctoFit!</h2>
